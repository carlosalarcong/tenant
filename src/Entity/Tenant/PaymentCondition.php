...
class PaymentCondition
{
    ...
    #[ORM\Column(name: 'interface_code', type: 'string', length: 10)]
    #[Assert\NotBlank(message: 'Interface code is required')]
    #[Assert\Length(max: 10)]
    private string $interfaceCode;

    #[ORM\Column(name: 'max_term', type: 'integer')]
    #[Assert\NotNull]
    private int $maxTerm = 0;

    #[ORM\Column(name: 'is_up_to_date', type: 'boolean')]
