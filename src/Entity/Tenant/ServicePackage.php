...
class ServicePackage
{
    ...
    #[ORM\OneToMany(mappedBy: 'servicePackage', targetEntity: ServicePackageDetail::class, cascade: ['persist', 'remove'])]
    ...
    public function setIsProgram(bool $isProgram): static
    {
    ...
    /**
     * @return Collection<int, ServicePackageDetail>
     */
    ...
    public function addDetail(ServicePackageDetail $detail): static
    {
        if (!$this->details->contains($detail)) {
            $this->details->add($detail);
            $detail->setServicePackage($this);
        }
        return $this;
    }

    public function removeDetail(ServicePackageDetail $detail): static
    {
        if ($this->details->removeElement($detail)) {
            if ($detail->getServicePackage() === $this) {
                $detail->setServicePackage(null);
            }
        }
        return $this;
    }
