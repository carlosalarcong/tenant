 ...
 *
 * Presupuesto clínico/comercial asociado a una persona, sucursal y condiciones
 * de atención, con sus ítems de detalle y observaciones de seguimiento.
 */
...
class Budget
{
    ...
    #[ORM\JoinColumn(name: 'care_type_id', referencedColumnName: 'id', nullable: true)]
    ...
    #[ORM\OneToMany(mappedBy: 'budget', targetEntity: BudgetDetail::class, cascade: ['persist', 'remove'])]
    private Collection $details;

    #[ORM\OneToMany(mappedBy: 'budget', targetEntity: BudgetObservation::class, cascade: ['persist', 'remove'])]
    ...
    public function includesHonorariums(): bool
    {
