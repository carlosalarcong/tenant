 ...
 * 
 * Gestiona el mantenedor de Items de Facturación
 */
...
class BillingItemController extends AbstractMantenedorController
{
    ...
    #[Route('', name: 'app_maintainers_billing_billing_item_index', methods: ['GET'])]
    public function index(Request $request): Response
    {
        return $this->handleIndex($request);
    }

    #[Route('/create', name: 'app_maintainers_billing_billing_item_create', methods: ['GET', 'POST'])]
    public function create(Request $request): Response
    {
        return $this->handleCreate($request);
    }

    #[Route('/{id}/edit', name: 'app_maintainers_billing_billing_item_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, int $id): Response
    {
        return $this->handleEdit($request, $id);
    }

    #[Route('/{id}/delete', name: 'app_maintainers_billing_billing_item_delete', methods: ['POST'])]
    public function delete(Request $request, int $id): Response
    {
        return $this->handleDelete($request, $id);
    }
    
    #[Route('/export', name: 'app_maintainers_billing_billing_item_export', methods: ['GET'])]
    public function export(Request $request): Response
    {
        return $this->handleExport(
            ...
            filename: 'items_facturacion_' . date('Y-m-d') . '.csv'
        );
    }
    ...
    {
        return 'app_maintainers_billing_billing_item_index';
    }

    protected function getPageTitle(?string $action = null): string
    {
        return match($action) {
            'create' => 'Crear Item de Facturacion',
            'edit' => 'Editar Item de Facturacion',
            default => 'Items de Facturacion'
        };
    }
